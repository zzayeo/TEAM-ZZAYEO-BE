...
const imgUploader = upload.single('imageFile');
...
// 상대방 공개 여행 목록 가져오기
router.get(ROUTE.AUTH.GET_USERS_INFO, authMiddleware, authController.getUserInfo);
// 유저 정보 조회
router.get(ROUTE.AUTH.GET_MY_INFO, authMiddleware, authController.getMyInfo);
// 유저 정보 수정
router.post(ROUTE.AUTH.UPDATE_MY_INFO, authMiddleware, imgUploader, authController.updateUserInfo);
// 유저 정보 삭제
...
// 구독 정보 등록
router.post(ROUTE.AUTH.SUBS, authMiddleware, authController.setUserSubscribe);
